...
/**
 * Created by alejorichdad on 8/23/16.
 */
public class BogotaDetEighteenthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bogota_det_eighteenth);
